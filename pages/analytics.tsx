      ...
      <div className="flex-1 space-y-8 p-1 sm:p-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-6 border-b border-border/60">
          <div className="space-y-1.5">
            ...
            <p className="text-sm text-muted-foreground">
              Comprehensive insights into fleet performance and costs.
            </p>
          </div>
          <DropdownMenu>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-2">
            ...
            <CardContent>
              <div className="text-3xl font-bold tracking-tight">
                {dashLoading ? (
                  ...
                  `${dashboard?.fuelEfficiency?.toFixed(1) || '0.0'} km/l`
                )}
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold tracking-tight">
                {dashLoading ? (
                  ...
                  `${dashboard?.fleetUtilization?.toFixed(0) || '0'}%`
                )}
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold tracking-tight">
                {dashLoading ? (
                  ...
                  `₹${(dashboard?.operationalCost || 0).toLocaleString()}`
                )}
              </div>
            </CardContent>
          </Card>
          ...
          <Card className={bentoCardStyle}>
            ...
            <CardContent>
              <div className="text-3xl font-bold tracking-tight">
                {reportsLoading ? <Skeleton className="h-8 w-16" /> : `${avgRoi.toFixed(1)}%`}
              </div>
                    ...
                    >
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-muted-foreground">
                          ₹{vehicle.operationalCost?.toLocaleString() || 0}
                        </span>
                      </div>
