        ...
        <div className="hidden lg:flex w-1/2 bg-primary flex-col justify-between p-12 text-primary-foreground relative overflow-hidden">
          ...
          >
            ...
            <p className="text-primary-foreground/80 text-lg max-w-md mb-12">
              Enterprise-grade logistics management. Track your fleet, manage drivers, and optimize
              routes from a single unified dashboard.
            </p>
          </motion.div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        value={watch('role')}
                        onValueChange={(val) => val && setValue('role', val as string)}
                      >
                        <SelectTrigger
                          className={
