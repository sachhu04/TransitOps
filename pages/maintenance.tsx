...
import { Wrench, CheckCircle2, Clock, Check, ChevronsUpDown, Download } from 'lucide-react';
...
export default function Maintenance() {
  ...
  } = useSWR('/api/maintenance', fetcher);
      ...
      <div className="flex-1 space-y-8 p-1 sm:p-4 h-[calc(100vh-140px)] flex flex-col">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-6 border-b border-border/60">
          <div className="space-y-1.5">
            ...
            <p className="text-sm text-muted-foreground">
              Schedule service and view vehicle maintenance history.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6 flex-1 min-h-0">
          ...
          {user?.role !== 'FINANCIAL_ANALYST' && (
            <Card
              className={`flex flex-col h-full overflow-hidden border-border shadow-sm lg:col-span-1 ${bentoCardStyle}`}
            >
              ...
              <div className="overflow-y-auto flex-1 p-6 space-y-6">
                <div className="space-y-2">
                  ...
                  <Popover open={vehicleOpen} onOpenChange={setVehicleOpen}>
                    ...
                    >
                      {selectedVehicle
                        ? // eslint-disable-next-line @typescript-eslint/no-explicit-any
                          vehicles.find((v: Record<string, any>) => v.id === selectedVehicle)
                            ?.registration
                        : 'Search vehicle...'}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    placeholder="Name of technician or external shop"
                    value={technician}
