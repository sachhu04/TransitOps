      ...
      <div className="min-h-screen flex items-center justify-center bg-muted/30 p-4">
        <div className="w-full max-w-md space-y-8">
          <div className="flex flex-col items-center text-center space-y-2">
            ...
            <p className="text-muted-foreground text-sm">Welcome! Please set up your password to activate your account.</p>
          </div>
          ...
          <Card className="border-border shadow-xl">
            {success ? (
              <CardContent className="pt-6 text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">Your password has been set successfully. You can now log in to your account.</p>
