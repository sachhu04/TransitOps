      ...
      <div className="flex-1 space-y-8 p-1 sm:p-4">
        ...
        <Tabs defaultValue="general" className="space-y-6">
          <TabsList>
            ...
            {user?.role === 'ADMIN' && <TabsTrigger value="team">Team Management</TabsTrigger>}
          </TabsList>
          ...
          <TabsContent value="general" className="space-y-6">
            <Card className={bentoCardStyle}>
              <CardHeader>
                ...
                <CardDescription>
                  Update your company details and primary depot location.
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Use kilometers across the platform.
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Default currency for all financial records.
                    </p>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Receive an email when a trip is dispatched or delayed.
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Get notified when vehicles are due for service.
                    </p>
                  </div>
                  <Switch defaultChecked />
                </div>
            ...
            <TabsContent value="team" className="space-y-6">
              <Card className={bentoCardStyle}>
                <CardHeader>
                  ...
                  <CardDescription>
                    Generate a magic link to invite a new employee to TransitOps.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form
              ...
              {invitations.length > 0 && (
                <Card className={bentoCardStyle}>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Users who have been invited but haven&apos;t set up their accounts.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Table>
